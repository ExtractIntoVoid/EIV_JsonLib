...
{
    public IArmor Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
    {
        DefaultArmor @default = new();
    ...
    public void Serialize(ref MessagePackWriter writer, IArmor value, MessagePackSerializerOptions options)
    {
        if (value == null)
        {
            writer.WriteNil();
